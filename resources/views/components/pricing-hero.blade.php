...
<section class="pricing-hero pricing-hero__mobile-frame retina-purple-field relative overflow-hidden pb-28 pt-28 max-lg:pb-12 sm:pb-32 sm:pt-32 lg:pb-40 lg:pt-24" data-live-gradient data-live-gradient-scroll-only data-live-gradient-intensity="cinematic" data-pricing-hero-motion aria-label="Preços Depiderme">
    <div class="pricing-hero__inner relative z-[1] isolate mx-auto w-full min-h-[640px] max-w-none sm:min-h-[720px] lg:min-h-[888px] lg:max-w-[1440px]">
        ...
        <div class="pricing-hero__copy pointer-events-none relative z-10 flex min-h-[inherit] items-center justify-center site-padding max-lg:mx-auto max-lg:max-w-[78%] max-lg:py-30 max-lg:pb-18 sm:max-lg:max-w-[68%] sm:max-lg:py-34 sm:max-lg:pb-20">
