@php
    ...
    $mobileNavButtonClass = 'experience-carousel__nav-button inline-flex size-[42px] shrink-0 cursor-pointer items-center justify-center rounded-full border border-black bg-[linear-gradient(180deg,#5B2B82_0%,#8A72AF_100%)] text-white transition-opacity hover:opacity-90';
@endphp
            ...
            @foreach ($cards as $card)
                ...
                >
                    <div class="experience-card__content flex flex-col items-start">
                        ...
                        <a
                            href="#"
                            class="experience-card__button mt-6 inline-flex min-w-[142px] items-center justify-center gap-2.5 rounded-full bg-[#271841] px-5 py-3 font-sans text-sm font-semibold leading-[18px] tracking-[-0.02em] text-white no-underline transition-opacity hover:opacity-90 sm:mt-8 sm:py-[15px]"
                        >
                            {{ $card['button'] }}
                        </a>
                    </div>
