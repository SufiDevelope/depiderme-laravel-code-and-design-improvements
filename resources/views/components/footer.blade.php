...
@php
    ...
    $footerHeadlineMatchesCuratedCopy = str_starts_with($footerHeadlineNormalized, 'O futuro da sua pele')
        && str_ends_with($footerHeadlineNormalized, 'da tecnologia');
    $footerHeadlineHtml = $footerHeadlineMatchesCuratedCopy
